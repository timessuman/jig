...
- Of the 111 rules, **14 can be decided by a machine** — a hard-coded colour, a
...
Running only the CLI gets you the 14. Running only the agent gets you the 97 with
...
| File | Contents |
| --- | --- |
| `rules/00-anti-patterns.md` | 94 universal rules with corrections |
